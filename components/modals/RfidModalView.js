...
const RfidModalView = ({ children, title, onSubmit, cancelable, visible = false, onDismiss}) => {
    return (
        <Modal
            animationType="fade"
            transparent={true}
                ...
                <View style={styles.modalView}>
                    ...
                    <View style={{ alignSelf: 'flex-end', alignItems: 'center',flexDirection: 'row', }}>
                        {cancelable && (<TouchableOpacity
                            ...
                            onPress={onDismiss}>
                            <Text style={[styles.textStyle, { color: 'green' }]}>Cancel</Text>
                        </TouchableOpacity>)}
